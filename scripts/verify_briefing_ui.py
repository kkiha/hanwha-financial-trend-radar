            ...
            try:
                ...
                with sync_playwright() as p:
                    ...
                    for i, counts in enumerate([(1,1), (0,1), (0,0)]):
                        page.locator("#company-tabs button").nth(i).click()
                        expect(page.locator(".brief-card")).to_have_count(counts[0])
                        expect(page.locator("article.monitor")).to_have_count(counts[1])
                    ...
                    page.locator("#company-tabs button").first.click()
                    page.locator(".brief-card details summary").click()
                    expect(page.locator(".brief-card .ev")).to_have_count(4)
                    print("PASS: three company states, all evidence, Escape/focus")
