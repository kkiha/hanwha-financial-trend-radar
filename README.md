...
- 그룹·회사별 1페이지 HTML 보고서 다운로드 및 인쇄/PDF 저장
...
2. 핵심 이슈와 회사 탭을 선택해 연결된 브리핑을 확인합니다. **근거 보기**에서 기사 목록과 원문 링크를 확인합니다.
3. **그룹 1페이지 보고서** 또는 **이 회사 보고서**에서 HTML을 다운로드하거나 **인쇄 / PDF**로 저장합니다. 인쇄 용지는 A4를 사용하고 브라우저 머리글·바닥글을 끄세요. 내용 길이와 인쇄 설정에 따라 페이지 수는 달라질 수 있습니다.
...
- **부분 완료 또는 특정 회사 결과 없음:** 화면 안내와 `latest_refresh.json`의 실패 단계·진단 정보를 확인하세요. API 제한·검증 실패 등이 원인일 수 있습니다.
...
- `app/frontend/`: 실제 화면 HTML·CSS·JS, 보고서 스타일, Pretendard 폰트와 라이선스
